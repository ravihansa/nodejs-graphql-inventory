...
import categoryTypeDef from './category/categoryTypeDef.js';

export const typeDefs = mergeTypeDefs([productTypeDef, inventoryTypeDef, categoryTypeDef]);
export const resolvers = mergeResolvers([productResolver, inventoryResolver, categoryResolver]);
